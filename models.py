...
class AgencyMaster(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        super(AgencyMaster, self).save(*args, **kwargs)
class AgencyProductMaster(models.Model):
    ...
    def save(self):
        ...
        if not self.prod_code:
            self.created_date=datetime.today()
            self.last_update_date=datetime.today()
            super(AgencyProductMaster, self).save()
    def __str__(self):
        return self.prod_code



class AgencyProductRiskMaster(models.Model):

    risk_code=models.CharField(primary_key=True,max_length=200)
    prod_code=models.ForeignKey(AgencyProductMaster,models.DO_NOTHING,db_column='prod_code',blank=True,null=True)
    ...
    def save(self, *args, **kwargs):
        self.created_date = datetime.today()
        self.last_update_date = datetime.today()
        super(AgencyProductRiskMaster, self).save(*args, **kwargs)
class Agency_Prod_Comm_Master(models.Model):
    agen_id = models.ForeignKey('AgencyMaster', models.DO_NOTHING, blank=False, null=False )
    prod_code = models.ForeignKey('AgencyProductMaster', models.DO_NOTHING, db_column='prod_code', blank=True, null=True)
    ...
    def save(self):
        ...
        super(Agency_Prod_Comm_Master, self).save()


class AgencyVehicleMaster(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.created_date = datetime.today()
        self.last_update_date = datetime.today()
        super(AgencyVehicleMaster, self).save(*args, **kwargs)


class AgencyVehicleDepriciation(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.created_date = datetime.today()
        self.last_update_date = datetime.today()
        super(AgencyVehicleDepriciation, self).save(*args, **kwargs)

class AgencyNcbMaster(models.Model):
    prod_code = models.ForeignKey('AgencyProductMaster', models.DO_NOTHING, db_column='prod_code', blank=True, null=True)
    ...
    def save(self, *args, **kwargs):
        self.created_date = datetime.today()
        self.last_update_date = datetime.today()
        super(AgencyNcbMaster, self).save(*args, **kwargs)

class AgencyClaimStatusMaster(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.created_date = datetime.today()
        self.last_update_date = datetime.today()
        super(AgencyClaimStatusMaster, self).save(*args, **kwargs)

class AgencyClaimsSurveyorMaster(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.created_date = datetime.today()
        self.last_update_date = datetime.today()
        super(AgencyClaimsSurveyorMaster, self).save(*args, **kwargs)
